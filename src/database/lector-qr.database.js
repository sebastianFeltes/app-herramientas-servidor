...
export const SelectHerramientaEnUso = `SELECT HER.*, ALU.nombre AS nombre_alumno, ALU.apellido AS apellido_alumno FROM rel_herramienta_usuario RHA 
...
export const InsertRetiroHerramienta = `INSERT INTO rel_herramienta_usuario
(id_herramienta, id_docente, id_alumno, fecha, hora, id_movimiento) VALUES (?, ?, ?, ?, ?, 1);
`;
//También se asigna el retiro, mov (1)
export const InsertUsoHerramienta = `INSERT INTO rel_herramienta_usuario
(id_herramienta, id_docente, id_alumno, fecha, hora, id_movimiento) VALUES (?, ?, ?, ?, ?, 2);
`;
//Si la herramienta está asignada a esa persona, pasa a ser del movimiento 2 (Uso) al 3 (Devolución).

export const InsertDevolucionHerramienta = `UPDATE rel_herramienta_usuario 
